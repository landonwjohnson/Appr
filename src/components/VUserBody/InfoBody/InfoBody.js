       ...
       <div>
        ...
        <Switch>
            ...
            <Route path="/user/:userid/account/settings/:userid" render={(props) => (
                  <AccountSettings userInfo={userInfo} handleNameSubmit={handleNameSubmit} handleEmailSubmit={handleEmailSubmit} handleAvatarSubmit={handleAvatarSubmit} handleInitials={handleInitials}  {...props} />
            )}/>
